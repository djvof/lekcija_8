...
namespace Exercises.Level1
{
    ...
    public class Array2
    {
        ...
        public int CenteredAverage(int[] nums)
        {
            ...
            int max = nums[0];
            int min = nums[0];
            int arraycount_ignoreTwo = (nums.Length - 2);
            foreach (var num in nums)
            {
                if (num > max) max = num;
                else if (num < min) min = num;
            }
            return (sum - max - min) / arraycount_ignoreTwo;
        ...
        public int Sum67(int[] nums)
        {
            ...
            foreach (var num in nums)
            {
                if (num == 6) trigger = true;
                if (! trigger) sum += num;
                if (num == 7) trigger = false;
            }
        ...
        {
            bool a = Array.Exists(nums, element => element == 1);
            bool b = Array.Exists(nums, element => element == 3);
            return !a && !b;
        }
        ...
        {
            bool a = Array.Exists(nums, element => element == 1);
            bool b = Array.Exists(nums, element => element == 4);
            return !a || !b;
        }
        ...
        public bool Either24(int[] nums)
        {
            ...
            for (int i = 0; i < nums.Length - 1; i++)
            {
                ...
                if (nums[i] == 2 && nums[i + 1] == 2) pair++;
                if (nums[i] == 4 && nums[i + 1] == 4) pair++;
            }
            return pair == 1;
        }
        ...
        public bool Has12(int[] nums)
        {
            ...
            foreach (var item in nums)
            {
                if (trigger && item ==2) return true;
                if (item == 1)  trigger = true;
            }
        ...
        public int[] Pre4(int[] nums)
        {
            ...
            foreach (var item in nums)
            {
                if(item == 4) return newarr.ToArray();
                newarr.Add(item);
            }
            return nums;
        }
        ...
        public int[] Post4(int[] nums)
        {
            ...
            {
                if (nums[i] == 4) {
                    ind = i; //get last index of 4
                }
            }
            if(ind==-1) return new int[0];
            var newarr = new List<int>();
